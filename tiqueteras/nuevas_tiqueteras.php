...
if(count($tiqueteras_excedidas) > 0)
{
	...
	for($i3=0;$i3<sizeof($tiqueteras_excedidas);$i3++)
	{
		...
		for($i_tareas_excedidas = 0;$i_tareas_excedidas< sizeof($tareas_excedidas);$i_tareas_excedidas++)
		{
			...
			if($quitar_puntos >= $tareas_excedidas[$i_tareas_excedidas][1])
			{
				$quitar_puntos = $quitar_puntos - $tareas_excedidas[$i_tareas_excedidas][1];//
				$tiempo_tarea = $tareas_excedidas[$i_tareas_excedidas][1];//300
