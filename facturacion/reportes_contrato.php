...
if(isset($_REQUEST["solicitudespp"]) && isset($_REQUEST["solicitudes_mes"]))
{
$lista_contratos=$_REQUEST["solicitudespp"];
$fecha_mes_contratos = $_REQUEST["solicitudes_mes"];
}



$obj_reportes= new Solicitudes();
$so = $obj_reportes->getSolicitudes_reporte2($lista_contratos,$fecha_mes_contratos);

if(count($so)==0)
{exit("No hay tareas de los meses seleccionados");}
...
$pdf->ln();
$pdf->ln();
$ta = $obj_reportes->getTareas_reporte2($so[$y]["id"],$fecha_mes_contratos);
...
$solicitudes2 = $obj_reportes->getTiposervicio_contratos($solicitudes2,$fecha_mes_contratos);
