<?php
  ...
  //require('includes/conexion/conexion.php');
...
//echo $body;
	...
	$mail->Host = "190.145.107.74";
	/* Sustituye  ( CuentaDeEnvio )  por la cuenta desde la que deseas enviar por ejem. 
	prueba@domitienda.com  */
...
*/
	...
	$mail->Username = "controlit@tornillosyabrasivos.com";
	$mail->Password = "*C0ntr0l1t2014*";
