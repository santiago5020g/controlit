...
<head>    
    ...
    <script type='text/javascript' src='../../calendar/tcal.js?v=3'></script>
    <link rel=stylesheet type=text/css href='../../calendar/tcal.css?v=1' />
...
<div class="bloque1_form" > 
  ...
  <input MaxLength="5" name="hora_inicio" id="hora_inicio" required type="text" value="<?php echo isset($event)?$hora_in[1]:date('H:i'); ?>" onkeydown="hour(this,event)" onkeyup="hour(this,event)" onChange="horas()" />                   
</div>
<div class="bloque1_form">
  <span>Hora fin</span>                     
  <input MaxLength="50"  name="hora_fin" id="hora_fin" required  type="text" value="<?php echo isset($event)?$hora_fi[1]:""; ?>" onkeydown="hour(this,event)" onkeyup="hour(this,event)" onChange="horas()" />
</div>  
<div class="bloque1_form">
