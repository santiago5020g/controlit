...
<head id="Head1">
    ...
    <script type="text/javascript">
        $(document).ready(function() {     
           var view="day";          
           var a="<?php echo $_REQUEST["usuarios"]; ?>";
            ...
            var op = {
                ...
                autoload:true,
                url: DATA_FEED_URL + "?method=list&usuarios="+a,  
            ...
            function cal_afterrequest(type,tarea,fecha_inicio_primera,hora_inicio_primera,fecha_actualizada,hora_actualizada)
            {
                switch(type)
                {
                    case 1:
                    ...
                    case 3:
                    case 4:
                        $("#loadingpannel").html("Success!"+fecha_actualizada);
                     ...
                     var user = "<?php echo $_REQUEST['usuario']; ?>";
                               $(document).ready(function(){
                                $(function() {
                                    $.ajax({ 
                                        ...
                                        data:'idtarea='+tarea+'&fecha_primera='+fecha_inicio_primera+'&hora_primera='+hora_inicio_primera+'&fecha_inicio2='+fecha_actualizada+'&hora_inicio2='+hora_actualizada+'&usuario='+user,
                                        success: function(respuesta) { 
                        ...
                        window.setTimeout(function(){ $("#loadingpannel").hide();},3000);
                    break;
                }              
            ...
            function Edit(data)
            {
               var eurl="edit.php?id={0}&start={2}&end={3}&isallday={4}&title={1}&usuario=<?php echo $_REQUEST['usuario']; ?>";   
                if(data)
                {
                    var url = StrFormat(eurl,data);
                    OpenModelWindow(url,{ width: 1000, height: 600, caption:"Manage  The Calendar",onclose:function(){
