...
<head>    
    ...
    <script type="text/javascript" src="cmb_jx.js?v=1"></script>
    <script src="hora.js?v=1" type="text/javascript"></script>   


    <script type='text/javascript' src='../../calendar/tcal.js?v=1'></script>
...
<div class="bloque1_form">
    ...
    <input MaxLength="10" name="fecha_inicio" id="fecha_inicio" class="tcal" onkeydown="dtval(this,event)" onkeyup="dtval(this,event)" type="text" value="<?php echo isset($event)?$sarr:date('d/m/Y');  ?>" /> 
</div>
<div class="bloque1_form" > 
  <span>Hora Inicio</span>                     
  <input MaxLength="5" name="hora_inicio" id="hora_inicio" type="text" value="<?php echo isset($event)?$hora_in[1]:date('H:i'); ?>" onkeydown="hour(this,event)" onkeyup="hour(this,event)" onChange="horas()" />                   
</div>
<div class="bloque1_form">
  <span>Hora fin</span>                     
  <input MaxLength="50"  name="hora_fin" id="hora_fin"  type="text" value="<?php echo isset($event)?$hora_fi[1]:""; ?>" onkeydown="hour(this,event)" onkeyup="hour(this,event)" onChange="horas()" />
</div>  
<div class="bloque1_form">
...
<div class="bloque1_form">
 ...
 <div class="bloque2_form">               
    <span> Detalles:</span>                    
    <textarea><?php echo isset($event)?$event->tarea_observaciones:""; ?></textarea>
</div>            
