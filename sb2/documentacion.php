...
<table>
    ...
    require("tran.php");
        ...
        $listado=$obj_archivos->getArchivos($parametro);
    ...
    <tr>
       <td> <a href="descargar.php?id=<?php echo $listado[$i]["idfile"];?>&ts=1" ><?php echo $listado[$i]["file_name"];?></a></td> <td><a href="javascript:confirmation(<?php echo $listado[$i]["idfile"];?>,<?php echo $parametro?>,1);">Eliminar</a> </td>
    </tr>
