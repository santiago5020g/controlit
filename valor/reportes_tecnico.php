...
if(isset($_REQUEST["solicitudespp"]))
{
$lista_solictudes=$_REQUEST["solicitudespp"];
}
...
for($x=0;$x<sizeof($ta);$x++)
{
		...
		$pdf->Cell(20,5,"Tarea");
		$pdf->SetFont('Arial','',9);
		$pdf->Cell(20,5,utf8_decode($ta[$x]["tarea"]));
		$pdf->SetFont('Arial','b',9);
...
{
	$pdf->SetFont('Arial','b',9);
	$pdf->Cell(45,5,utf8_decode($solicitudes2[$i]["tipos_nombre"]));
	$pdf->SetFont('Arial','',9);
...
$pdf->Output("Informe_facturacion.pdf","F");
