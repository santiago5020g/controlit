...
public function rowCount($vectore,$URL,$variables,$contenido)
{
...
//echo "<a class='$class' href=javascript:Pagina($this->param)>$this->btn_first_page</a>";
echo "<a class='$class' href=javascript:Paginaa($this->URL,$this->variables,$this->contenido$this->param)>$this->btn_first_page</a>";

//echo "<a class='$class'  href='?back_page=$this->page&item=$this->item&max=$this->max_pages".$this->param."'>$this->btn_back_page</a>";
//echo "<a class='$class' href=javascript:Pagina($this->page,$this->item,$this->max_pages,$this->uno)>$this->btn_back_page</a>";
echo "<a class='$class' href=javascript:Paginaa($this->URL,$this->variables,$this->contenido,$this->page,$this->item,$this->max_pages,$this->uno)>$this->btn_back_page</a>";
...
//echo "<a class='$class$active' href=javascript:Pagina($x,$this->item,$this->max_pages)>$p</a>";
echo "<a class='$class$active' href=javascript:Paginaa($this->URL,$this->variables,$this->contenido,$x,$this->item,$this->max_pages)>$p</a>";
...
//echo "<a class='$class'  href=javascript:Pagina($this->page,$this->item,$this->max_pages)>$this->btn_next_page</a>";
echo "<a class='$class'  href=javascript:Paginaa($this->URL,$this->variables,$this->contenido,$this->page,$this->item,$this->max_pages)>$this->btn_next_page</a>";
...
//echo "<a class='$class' href=javascript:Pagina($this->page,$this->item,$this->max)>$this->btn_last_page</a>";
echo "<a class='$class' href=javascript:Paginaa($this->URL,$this->variables,$this->contenido,$this->page,$this->item,$this->max)>$this->btn_last_page</a>";
}
}
}
